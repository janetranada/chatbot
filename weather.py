...
def get_weather(city):
    ...
    if response:
        ...
        feels_like_temp = resp_json["main"]["feels_like"]
        return f"{city.title()}, {country} has {weather_description} right now. Current temperature is {actual_temp} celsius, but it feels like {feels_like_temp} celsius."
    else:
        return "Sorry. The location you typed is not recognized."
